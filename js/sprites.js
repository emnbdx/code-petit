...
const Sprites = (() => {
  ...
  function makeCatSVGs(c) {
    ...
    <svg class="hero-svg" data-dir-svg="2" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Tail -->
      <path d="M35 37 Q43 28 39 18 Q37 14 35 19" fill="none" stroke="${c.p}" stroke-width="3.5" stroke-linecap="round"/>
      <!-- Body -->
      <ellipse cx="24" cy="30" rx="13" ry="10" fill="${c.p}" stroke="${c.pd}" stroke-width="1.5"/>
      ...
      <!-- Ears -->
      <polygon points="13,9 10,2 19,9" fill="${c.p}" stroke="${c.pd}" stroke-width="1.2"/>
      <polygon points="35,9 38,2 29,9" fill="${c.p}" stroke="${c.pd}" stroke-width="1.2"/>
    ...
    <svg class="hero-svg" data-dir-svg="0" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <ellipse cx="32" cy="41" rx="5" ry="3" fill="${c.p}" stroke="${c.pd}" stroke-width="1"/>
      <!-- Tail -->
      <path d="M36 35 Q44 25 40 15" fill="none" stroke="${c.p}" stroke-width="3.5" stroke-linecap="round"/>
      <!-- Body -->
      <ellipse cx="24" cy="30" rx="13" ry="10" fill="${c.pd}" stroke="${c.pd}" stroke-width="1.5"/>
      ...
      <!-- Ears from behind -->
      <polygon points="13,9 10,2 19,9" fill="${c.pd}" stroke="${c.pd}" stroke-width="1.2"/>
      <polygon points="35,9 38,2 29,9" fill="${c.pd}" stroke="${c.pd}" stroke-width="1.2"/>
    </svg>`;
    ...
    <svg class="hero-svg" data-dir-svg="1" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Tail -->
      <path d="M8 34 Q2 24 6 16 Q8 11 10 16" fill="none" stroke="${c.p}" stroke-width="3.5" stroke-linecap="round"/>
      <!-- Body -->
      <ellipse cx="24" cy="30" rx="12" ry="10" fill="${c.p}" stroke="${c.pd}" stroke-width="1.5"/>
      ...
      <!-- Ear -->
      <polygon points="33,9 37,2 30,9" fill="${c.p}" stroke="${c.pd}" stroke-width="1.2"/>
    ...
    <svg class="hero-svg" data-dir-svg="3" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <ellipse cx="30" cy="41" rx="5" ry="3" fill="${c.p}" stroke="${c.pd}" stroke-width="1"/>
      <!-- Tail -->
      <path d="M40 34 Q46 24 42 16 Q40 11 38 16" fill="none" stroke="${c.p}" stroke-width="3.5" stroke-linecap="round"/>
      <!-- Body -->
      <ellipse cx="24" cy="30" rx="12" ry="10" fill="${c.p}" stroke="${c.pd}" stroke-width="1.5"/>
      ...
      <!-- Ear -->
      <polygon points="15,9 11,2 18,9" fill="${c.p}" stroke="${c.pd}" stroke-width="1.2"/>
  ...
  function makeRobotSVGs(c) {
    ...
    <svg class="hero-svg" data-dir-svg="2" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Arms -->
      <rect x="5" y="22" width="6" height="10" rx="2" fill="${c.p}" stroke="${c.pd}" stroke-width="1.2"/>
      <rect x="37" y="22" width="6" height="10" rx="2" fill="${c.p}" stroke="${c.pd}" stroke-width="1.2"/>
      <!-- Body -->
      <rect x="11" y="21" width="26" height="19" rx="3" fill="${c.p}" stroke="${c.pd}" stroke-width="1.5"/>
      <!-- Body panel -->
      ...
      <!-- Antenna -->
      <line x1="24" y1="6" x2="24" y2="1" stroke="${c.pd}" stroke-width="1.5" stroke-linecap="round"/>
    ...
    <svg class="hero-svg" data-dir-svg="0" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="26" y="38" width="9" height="5" rx="2" fill="${c.p}" stroke="${c.pd}" stroke-width="1.2"/>
      <!-- Arms -->
      <rect x="5" y="22" width="6" height="10" rx="2" fill="${c.pd}" stroke="${c.pd}" stroke-width="1.2"/>
      <rect x="37" y="22" width="6" height="10" rx="2" fill="${c.pd}" stroke="${c.pd}" stroke-width="1.2"/>
      <!-- Body back -->
      <rect x="11" y="21" width="26" height="19" rx="3" fill="${c.pd}" stroke="${c.pd}" stroke-width="1.5"/>
    ...
    <svg class="hero-svg" data-dir-svg="1" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="26" y="38" width="9" height="5" rx="2" fill="${c.p}" stroke="${c.pd}" stroke-width="1.2"/>
      <!-- Arm front -->
      <rect x="36" y="22" width="5" height="10" rx="2" fill="${c.p}" stroke="${c.pd}" stroke-width="1.2"/>
      <!-- Body side -->
      <rect x="13" y="21" width="24" height="19" rx="3" fill="${c.p}" stroke="${c.pd}" stroke-width="1.5"/>
    ...
    <svg class="hero-svg" data-dir-svg="3" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="26" y="38" width="9" height="5" rx="2" fill="${c.p}" stroke="${c.pd}" stroke-width="1.2"/>
      <!-- Arm front -->
      <rect x="7" y="22" width="5" height="10" rx="2" fill="${c.p}" stroke="${c.pd}" stroke-width="1.2"/>
      <!-- Body side -->
      <rect x="11" y="21" width="24" height="19" rx="3" fill="${c.p}" stroke="${c.pd}" stroke-width="1.5"/>
